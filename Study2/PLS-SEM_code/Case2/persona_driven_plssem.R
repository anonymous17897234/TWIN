...
answer_path <- "../../Data_Case2/Persona_Driven_prompting/llm_responses.csv"
...
output_file_txt <- "../../analysis_result/PLS-SEM/Case2/persona_driven_plssem.txt" 
output_file_csv <- "../../analysis_result/PLS-SEM/Case2/persona_driven_plssem.csv"  
