...
idv_data_path <- "../../data/baseline_prompting/llm_responses.csv" 
...
output_file_txt <- "../../analysis_result/PLS-SEM/baseline_prompting_plssem.txt"  
output_file_csv <- "../../analysis_result/PLS-SEM/baseline_prompting_plssem.csv"  
