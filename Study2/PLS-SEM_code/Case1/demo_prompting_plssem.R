...
answer_path <- "../../Data_Case1/Demo_prompting/llm_responses.csv"
...
output_file_txt <- "../../analysis_result/PLS-SEM/Case1/demo_prompting_plssem.txt"  
output_file_csv <- "../../analysis_result/PLS-SEM/Case1/demo_prompting_plssem.csv"  
