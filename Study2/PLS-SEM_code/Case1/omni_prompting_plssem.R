...
given_data_path <- "../../Case1_latent.csv"
answer_path <- "../../Data_Case1/Omni_prompting/llm_responses.csv"
...
output_file_txt <- "../../analysis_result/PLS-SEM/Case1/omni_prompting_plssem.txt"  
output_file_csv <- "../../analysis_result/PLS-SEM/Case1/omni_prompting_plssem.csv"  
